...
def map_over_rows(df):
    ...
    for front in df.columns:
        base_text = """
bpm_front_attraction_dispatch_ig_bpm_front_WWW = {
    type = interest_group
...
"""
    ...
    with open("better-politics-mod/common/customizable_localization/bpm_front_ttgen.txt", "w") as f:
        f.write("\n".join(t))
